function channel  =  sshfrommatlab_publickey_file(userName,hostName,port,private_key, private_key_password)
...
%    David Scott Fra.ieedman (dfreedma@bu.edu)
%    Version 1.3
%
...
%
  ...
  if(nargin  ~=  5)
    error('Error: SSHFROMMATLAB_PUBLICKEY_FILE requires 5 input arguments...');
  end
