classdef (HandleCompatible) MeasurementHandler
...
%     end
	...
	methods
		function obj = MeasurementHandler()
        ...
        function obj = set.sizes(obj, sizes_)
            ...
            if isstruct(obj.names) || isstruct(obj.units) || ...
                ...
                if isstruct(obj.sizes)
                    ...
                    assert(numel(new) > 0, 'Empty structs cannot contain numeric sizes, thus cannot do the job of obj.size. obj.sizes should not have been able to be set to this; something is very wrong.')
                end
