classdef Tracker < Modules.Driver
    ...
    methods(Access=protected)
        function obj = Tracker(stage,stageDriver)
            obj.stage = stage;
    ...
    methods(Static)
        function obj = instance(stage,stageDriver)
            ...
            obj = Drivers.Tracker(stage,stageDriver);
            obj.singleton_id = id;
            Objects(end+1) = obj;
        end
    end
    methods
        ...
        function Track(obj,verbose)
            ...
            try
                ...
                data = imagesc(ax,V,pos(2),NaN(numel(V),1));
                ...
                data = imagesc(ax,pos(1),V,NaN(1,numel(V)));
