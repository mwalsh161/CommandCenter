classdef FMModulationCTIA < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        prefs = {'nAverages','start_freq','stop_freq','number_points','freq_step_size'...
            ...
            'Mode','ModulationDeviation','FMChannel','IntegrationTime','GateVoltage'}      
    end
    ...
    properties(SetObservable)
        ...
        FMChannel = 1;
        OutputVoltage = 3;
        IntegrationTime = 1; %in microseconds
        GateVoltage = {'1.2','1.8','2.5','3.3','5'}; 
    end
    
    methods(Access=private)
        function obj = FMModulationCTIA()
            obj.loadPrefs;
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.FMModulationCTIA();
            end
            obj = Object;
        end
    end
    ...
    methods
        ...
        function data = GetData(obj,~,~)
            ...
            data.Clock.IntegrationTime = obj.IntegrationTime;
