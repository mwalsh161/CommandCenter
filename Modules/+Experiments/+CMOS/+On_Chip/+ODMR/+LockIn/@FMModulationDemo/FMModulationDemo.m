classdef FMModulationDemo < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        prefs = {'nAverages','start_freq','stop_freq','number_points','freq_step_size'...
            ...
            'Mode','ModulationDeviation','FMChannel','VoltageMode'}      
    end
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.FMModulationDemo();
            end
            obj = Object;
        end
    end
