classdef FSK < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        prefs = {'nAverages','start_freq','stop_freq','number_points','freq_step_size'...
            'waitSGSwitch','frequency','ExtRefTrigImp','CurrentGain',...
            'Sensitivity','DetectionHarmonic','TimeConstant','Slope','Sync','GroundingType'...
            'Channel','ChannelMode','DataChanel1','DataChanel2','PowerMeter','ModulationDeviation'...
            'Mode','FMChannel','innerLoopNumber','loops','dummyLine'}    
    ...
    properties(SetObservable)
        ...
        FMChannel = 1;
        innerLoopNumber = 1000;
        loops = 1e6;
        dummyLine = 3;
        ModulationDeviation = 3; %Hz
    end
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.FSK();
            end
            obj = Object;
        end
    end
    ...
    methods
        ...
        function data = GetData(obj,~,~)
            ...
            data.RF.frequency = obj.frequency;
            data.RF.waitSGSwitch = obj.waitSGSwitch;
