classdef ODMR_Diode_LockIn < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        prefs = {'DriverBias','PhotoDiodeBias','nAverages','start_voltage','stop_voltage','number_points',...
            'waitTimeVCOswitch','norm_voltage','VCO_CTRL_Line','frequency','dutyCycle','ExtRefTrigImp','CurrentGain'...
    ...
    methods(Access=private)
        function obj = ODMR_Diode_LockIn()
            obj.loadPrefs;
        end
    end
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.ODMR_Diode_LockIn();
            end
            obj = Object;
        end
    end
