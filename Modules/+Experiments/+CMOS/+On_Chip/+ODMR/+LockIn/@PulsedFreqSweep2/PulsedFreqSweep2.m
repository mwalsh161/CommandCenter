classdef PulsedFreqSweep2 < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        prefs = {'nAverages','start_freq','stop_freq','number_points','freq_step_size'...
            ...
            'Channel','ChannelMode','DataChanel1','PowerMeter','TrigTime','laserDelay'...
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.PulsedFreqSweep2();
            end
            obj = Object;
        end
    end
