classdef SquareWavePulse < Experiments.CMOS.CMOS_invisible 
    ...
    properties
        ...
        ChipControl
        LockIn
        prefs = {'nAverages','MWfreq1','MWfreq2','number_points','Degauss'...
            ...
            'Mode','ModulationDeviation','FMChannel','DCCurrentInitial','DCCurrentFinal','onTime'}      
    end
    ...
    properties(SetObservable)
        ...
        MWfreq1 = 2.84e9;
        MWfreq2 = 2.86e9;
        number_points = 61; %number of time points desired
        Degauss = {'yes','no'}
        ...
        PowerMeter = {'Yes','No'}
        AutoScale = {'Yes','No'}
        frequency = 1e3; %FM frequency
        Mode = {'voltage','current'}
        DCCurrentInitial = 0; %Amps
        DCCurrentFinal = 0.1; %Amps 
        onTime = 20; %seconds; 1 over square wave frequency
    ...
    methods(Static)
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.CMOS.On_Chip.ODMR.LockIn.SquareWavePulse();
            end
            obj = Object;
        end
    end
    ...
    methods
        ...
        function data = GetData(obj,~,~)
            ...
            data.ElectroMagnet.Degauss = obj.Degauss;
            data.ElectroMagnet.onTime = obj.onTime;
            
            data.PowerMeter.opticalPower = obj.opticalPower;
            
            data.RF.MWfreq1 = obj.MWfreq1;
            data.RF.MWfreq2 = obj.MWfreq2;
            ...
            data.RF.OutputVoltage = obj.OutputVoltage;
