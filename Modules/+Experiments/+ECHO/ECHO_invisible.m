classdef ECHO_invisible  < Modules.Experiment 
    ...
    properties (SetObservable)
        ...
        RF_power = -30;
        nAverages = 5;
        Integration_time = 30;  %in ms: time for each data point
        laser_read_time = 300;
        piTime = 500; %ns
        start_time = 14;%ns
        stop_time = 1000;%ns
    ...
    methods(Static)
        ...
        function obj = instance()
            ...
            if isempty(Object) || ~isvalid(Object)
                Object = Experiments.ECHO.ECHO_invisible();
            end
            obj = Object;
        end
    ...
    methods
        ...
        function run(obj,statusH,managers,ax)
            ...
            newButton = add_button(button,'Quit and Save');
            newButton.Callback = @obj.quit_and_save;
            obj.ax = ax;
        ...
        function quit_and_save(obj,~,~)
            obj.quit = true;
            obj.logger.log('Quit Experiment Echo requested. Saving Data.');
            obj.abort;
            obj.GetData;
        end
    end
