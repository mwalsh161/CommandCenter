function obj = instance(varargin)
    ...
    persistent Objects
    if isempty(Objects)
        Objects = Experiments.PulseSequenceSweep.OpticalSpinPolarizationAndReadoutEOM.empty(1,0);
    end
    ...
    obj = Experiments.PulseSequenceSweep.OpticalSpinPolarizationAndReadoutEOM(varargin{:});
