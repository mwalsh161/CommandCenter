...
resStart = node(resStart,resChannel,'units','us','delta',obj.resTime_us);

for n = 1:nCounters
    counterStart = node(resStart,APDchannel,'units','us','delta',(n-1)*(obj.counterDuration+obj.counterSpacing)+obj.measureOffset);
