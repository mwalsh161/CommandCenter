classdef EOMscan < Experiments.SlowScan.SlowScan_invisible
    ...
    properties(SetObservable,GetObservable,AbortSet)
        ...
        measure_laser_freq =    Prefs.Boolean(false,     'help_text', 'Whether to measure the laser wavelength with the wavemeter.');
    end
    ...
    methods(Access=private)
        function obj = EOMscan()
            ...
            obj.prefs = [{'MWsource','laser_freq_THz','MW_freq_MHz','measure_laser_freq'}, obj.prefs];
