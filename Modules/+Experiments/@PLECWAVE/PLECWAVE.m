classdef PLECWAVE < Modules.Experiment
...
%         vars = {'scan_points'}; %names of variables to be swept
    ...
    properties
        prefs = {'percents', 'tune_coarse', 'set_wavelength', 'wavemeter_override','wavemeter_channel','repumpLaser', 'camera1', 'cameraEMCCD','EMCCD_binning', 'EMCCD_exposure', 'EMCCD_gain'};  % String representation of desired prefs
