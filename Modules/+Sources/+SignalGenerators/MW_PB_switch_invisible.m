classdef MW_PB_switch_invisible < Sources.SignalGenerators.SG_Source_invisible
    %PB MW source class
    properties
        MW_switch
        running
    ...
    methods
        function obj = MW_PB_switch_invisible()
            % Because super class already defines
            obj.prefs = [obj.prefs,{'ip','MW_switch_PB_line','SG_trig_PB_line'}];
            obj.show_prefs = [obj.show_prefs,{'ip','MW_switch_on','MW_switch_PB_line','SG_trig_PB_line'}];
        end
    end
