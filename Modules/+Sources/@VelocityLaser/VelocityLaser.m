classdef VelocityLaser < Modules.Source & Sources.TunableLaser_invisible
    ...
    properties(SetObservable,GetObservable)
        ...
        wheel_host =              Prefs.String(Sources.VelocityLaser.noserver, 'set','set_wheel_host', 'help', 'IP/hostname of computer with hwserver for Arduino-controlled filter wheel.');
