classdef BSC203 < Modules.Stage
    ...
    properties(SetObservable,AbortSet)
        controller = @Drivers.Kinesis.KinesisBSC203.getAvailMotors;  % Motor serial number
    ...
    methods
        ...
        function setMotor(obj,val)
            ...
            % Add new motor
            obj.motors{axis} = Drivers.Kinesis.KinesisBSC203.instance(val, [0 4]);
