function varargout = StageManagerEdit(varargin)
%STAGEMANAGEREDIT M-file for StageManagerEdit.fig
%      STAGEMANAGEREDIT, by itself, creates a new STAGEMANAGEREDIT or raises the existing
%      singleton*.
%
%      H = STAGEMANAGEREDIT returns the handle to a new STAGEMANAGEREDIT or the handle to
%      the existing singleton*.
%
%      STAGEMANAGEREDIT('Property','Value',...) creates a new STAGEMANAGEREDIT using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to StageManagerEdit_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      STAGEMANAGEREDIT('CALLBACK') and STAGEMANAGEREDIT('CALLBACK',hObject,...) call the
%      local function named CALLBACK in STAGEMANAGEREDIT.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help StageManagerEdit
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @StageManagerEdit_OpeningFcn, ...
                   'gui_OutputFcn',  @StageManagerEdit_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before StageManagerEdit is made visible.
function StageManagerEdit_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for StageManagerEdit
...
function varargout = StageManagerEdit_OutputFcn(hObject, eventdata, handles)
