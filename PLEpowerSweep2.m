function PLEpowerSweep2(managers)
...
%     pm.set_range(1)
    ...
    for ii = 1:length(cset)
        ...
        for jj = 1:length(mang)
            ...
            disp(['405nm current: ' num2str(cset(ii)) ', Msquared wheel angle: ' num2str(mang(jj))])
